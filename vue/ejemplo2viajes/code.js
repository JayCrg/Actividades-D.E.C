...
createApp({
    ...
    {
        entradasDeEspana(){
            return this.entradas.filter((ent)=>ent.ubicacion.pais == 'España').length //si le quitamos el length tenemos un array para trabajar como queramos
        }
    }
}
).mount('#app')